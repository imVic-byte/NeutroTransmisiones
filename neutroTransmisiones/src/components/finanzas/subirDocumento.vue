...
<template>
  <div class="space-y-2 px-6">
    <label class="block text-sm font-bold neutro-font">Documentos Adjuntos (Opcionales)</label>
    ...
    <div class="flex items-center justify-center w-full">
      <label for="subir-archivo" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-100 border-dashed rounded-lg cursor-pointer bg-slate-50 hover:bg-slate-100 transition-colors servi-adapt-bg">
        <div class="flex flex-col items-center justify-center pt-5 pb-6">
          ...
          <p class="mb-2 text-sm neutro-font"><span class="font-bold">Haz clic para subir</span> o arrastra y suelta los documentos</p>
          <p class="text-xs neutro-font">PDF, JPG, PNG o Excel</p>
        </div>
    ...
    <div v-if="archivosSeleccionados.length > 0" class="mt-4 space-y-2">
      <p class="text-sm font-bold neutro-font">Archivos seleccionados:</p>
      <ul class="space-y-1">
