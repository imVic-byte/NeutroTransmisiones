...
<template>
  <div class="space-y-2 px-6">
    ...
    <div class="flex items-center justify-center w-full">
      <label for="subir-archivo" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-100 border-dashed rounded-lg cursor-pointer bg-slate-50 hover:bg-slate-100 transition-colors neutro-secondary">
