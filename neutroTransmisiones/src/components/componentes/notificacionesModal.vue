...
<template>
  <Transition name="modal">
    <div class="modal-overlay" @click.self="emit('cerrar')">
      <div class="modal-panel pt-15 neutro-background neutro-font">
        <!-- Header -->
        <div class="modal-header neutro-primary">
        ...
        <div v-if="notificacionesNoLeidas > 0" class="mark-all-bar neutro-secondary">
          <button @click="emit('marcarTodasLeidas'), emit('marcarTodasLeidasDeuda')" class="btn-mark-all neutro-font neutro-font">
            ...
            <p class="neutro-font">Marcar todas como leídas</p>
          </button>
        </div>
        ...
        <div class="notifications-list">
          <div
            ...
            :key="notif.id"
            class="notification-item neutro-secondary neutro-font"
            :class="{ 'notification-unread': !notif.leido }"
          >
            <div class="notification-dot-col">
              <span v-if="!notif.leido" class="notification-dot"></span>
            </div>
            <div class="notification-content neutro-font">
              <p class="notification-title neutro-font">{{ notif.titulo }}</p>
            ...
            <button v-if="notif.tipo==='notificacion'" class="neutro-primary neutro-font rounded-full px-4 py-2" @click="handleIrAOT(notif.id, notif.id_resource)">
                Ver
            </button>
            <button v-if="notif.tipo==='deuda'" class="neutro-primary neutro-font rounded-full px-4 py-2" @click="handleIrADeuda(notif.id, notif.deuda)">
                Ver
            </button>
          </div>
