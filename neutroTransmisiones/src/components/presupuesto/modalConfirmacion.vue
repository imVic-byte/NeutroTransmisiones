...
<template>
  <div class="flex flex-col gap-4 w-full justify-center">
    ...
    <button v-if="estado !== 1" @click="ejecutarBorrador" class="neutro-font px-4 py-2 rounded-lg neutro-font cursor-pointer flex items-center gap-2 justify-center">
      <svg class="w-6 h-6 neutro-font dark:neutro-font" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
