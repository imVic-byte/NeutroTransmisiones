...
<template>
    <button @click.stop="abrirModal" class="mt-2 flex rounded-lg neutro-font neutro-font justify-center items-center px-3 py-2 w-full mx-auto transition-colors hover:bg-yellow-400">
