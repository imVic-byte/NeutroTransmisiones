...
<template>
  <div class="flex flex-col items-center justify-center p-8 neutro-primary rounded-xl shadow-2xl w-full max-w-md mx-auto">
    ...
    <div class="flex items-center justify-between w-full mb-2">
      <span class="text-xs font-bold neutro-font uppercase tracking-widest">Nivel de Combustible</span>
