...
<div v-if="cotizacion" class="neutro-background min-h-screen">
    ...
    <div class="mx-auto p-4 max-w-5xl pb-28">
        ...
        <div v-if="modalConfirmacion" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div class="neutro-background rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <div class="px-6 py-4 flex gap-3 border-t border-gray-200">
              ...
              <button 
                ...
                :class="[
                  ...
                  formularioValido 
                    ? 'neutro-primary text-white hover:opacity-90 cursor-pointer' 
