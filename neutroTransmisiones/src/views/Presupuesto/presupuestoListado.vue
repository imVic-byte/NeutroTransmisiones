    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="hidden md:grid md:grid-cols-4 gap-4 mb-8">
        <div class="neutro-secondary p-4 rounded-xl shadow-sm border border-gray-100">
            <p class="text-xs neutro-font uppercase font-bold">Total Presupuestos / mes</p>
        ...
        <div class="neutro-secondary p-4 rounded-xl shadow-sm border border-gray-100">
            <p class="text-xs neutro-font uppercase font-bold">Confirmados / mes</p>
            <p class="text-2xl font-bold text-green-600">{{ stats.confirmados }}</p>
        </div>
        <div class="neutro-secondary p-4 rounded-xl shadow-sm border border-gray-100">
            <p class="text-xs neutro-font uppercase font-bold">Flujo Potencial / mes</p>
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center gap-2">
          ...
          <button 
            @click="irACrear" 
            class="neutro-font neutro-font font-bold py-2 px-6 rounded-lg shadow-sm hover:opacity-90 transition-all flex items-center gap-2"
          >
      ...
      <div v-if="servicios.length === 0" class="neutro-secondary rounded-xl p-10 text-center shadow-sm border border-gray-100 md:hidden">
