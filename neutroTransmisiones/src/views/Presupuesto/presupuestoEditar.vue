...
<template>
  <div class="neutro-background min-h-screen font-sans">
    <navbar titulo="NeutroTransmisiones" :subtitulo="'Editar Presupuesto #' + (numero_folio || '')" class="navbar sticky top-0 z-50 shadow-sm" />
    ...
    <div v-if="cargado" class="mx-auto p-4 max-w-7xl pb-28 pt-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 rounded-lg">
        ...
        <div class="lg:col-span-7 space-y-12 servi-adapt-bg rounded-xl">
          ...
          <section>
            <h2
              class="text-2xl font-light w-full neutro-primary neutro-font border-b-2 border-yellow-400 rounded-t-lg p-2 inline-block pb-1 mb-6">
              Cliente
            </h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 px-3">
              <div class="group">
