...
<template>
  <div class="min-h-screen neutro-background font-sans">
    <navbar titulo="NeutroTransmisiones" :subtitulo="'Editar Ficha de Gastos'" class="navbar"></navbar>
    <div class="max-w-7xl mx-auto pt-5 pb-30 px-4 md:px-8">
      ...
      <div v-else>
        <div class="mb-6">
          <button @click="router.push(`/gastos/ver/${idFicha}`)" class="mb-4 flex items-center gap-1 text-sm neutro-font hover:opacity-80 transition cursor-pointer">
          ...
          <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mt-2">
            ...
            <div class="flex gap-2 w-full md:w-auto">
              <button @click="guardarCambios" :disabled="guardando" class="flex-1 md:flex-none neutro-primary text-white px-6 py-2.5 rounded-lg shadow-md font-bold text-sm disabled:opacity-50">
            ...
            <div class="servi-adapt-bg rounded-lg shadow-sm border border-gray-100">
              ...
              <div v-else class="hidden md:block overflow-x-auto">
                <table class="min-w-full">
                  <thead>
                    <tr>
                      <th class="px-6 py-3 text-left text-xs font-bold neutro-font uppercase bg-slate-50">Concepto</th>
                      <th class="px-6 py-3 text-left text-xs font-bold neutro-font uppercase bg-slate-50">Categoría</th>
                      <th class="px-6 py-3 text-right text-xs font-bold neutro-font uppercase bg-slate-50">Monto</th>
