...
import { categorias, opciones } from './js/constantes.js'
...
<template>
  <div class="neutro-background min-h-screen pb-15">
    <navbar titulo="NeutroTransmisiones" subtitulo="Nuevo Chequeo" class="sticky top-0 z-50" />

    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <volver />

      <div v-if="ot" class="servi-adapt-bg rounded-xl shadow-sm border border-gray-100 mb-6">
        <div class="flex items-center justify-between mb-3 neutro-primary py-6 px-3 rounded-t-xl">
      ...
      <button @click="guardarChequeo"
        :class="[
          ...
          todosCompletos ? 'neutro-primary hover:opacity-90' : 'bg-gray-300 cursor-not-allowed'
        ]">
        Guardar Chequeo
      </button>
    </div>
