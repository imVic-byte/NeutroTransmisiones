...
<template>
  <div class="neutro-background min-h-screen pb-15 print:bg-white print:pb-0">
    <navbar titulo="NeutroTransmisiones" subtitulo="Ver Chequeo" class="sticky top-0 z-50 print:hidden" />
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 print:px-2 print:py-0">
      ...
      <div v-if="chequeo">
        ...
        <div class="flex gap-3 print:hidden">
          ...
          <button @click="irAEditar" v-if="Creador"
            class="flex-1 py-3.5 rounded-xl font-bold text-white neutro-primary hover:opacity-90 transition-all active:scale-95 cursor-pointer shadow-sm">
            Editar Chequeo
          </button>
        </div>
      </div>
