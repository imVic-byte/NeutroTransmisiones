...
<template>
  <div class="neutro-background min-h-screen pb-15">
    <navbar :titulo="'NeutroTransmisiones'" subtitulo="Trabajos por entregar" search-input="false" class="sticky top-0 z-50"/>
    
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  <volver />
      <div class="flex justify-between items-center mb-6">
        <div>
          <h2 class="text-xl font-bold neutro-font">Trabajos por Entregar</h2>
          ...
          <div class="p-4">
            ...
            <div class="flex justify-between items-center mb-3">
              <div class="flex items-center gap-2">
                <span class="text-xl font-black neutro-font tracking-wide">#{{ ficha.id }}</span>
              </div>
              <span 
            ...
            <div v-for="(ot, i) in ficha.orden_trabajo" :key="i" class="text-sm font-bold neutro-font mb-3">
