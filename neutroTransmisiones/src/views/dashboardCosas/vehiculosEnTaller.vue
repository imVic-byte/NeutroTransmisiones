...
<template>
  <div class="neutro-background min-h-screen pb-15">
    <navbar :titulo="'NeutroTransmisiones'" subtitulo="Vehículos en taller" search-input="false" class="sticky top-0 z-50"/>
    
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  <volver />
      <div class="flex justify-between items-center mb-6">
        <div>
          <h2 class="text-xl font-bold neutro-font">Vehículos en Taller</h2>
          ...
          <div class="p-4">
            ...
            <div v-if="item.cliente" class="flex items-center gap-3 pt-3 border-t border-gray-100 mt-2">
              ...
              <button 
                ...
                class="neutro-primary text-white px-4 py-2 rounded-xl text-xs font-black shadow-sm active:scale-95 transition-transform"
              >
                VER
              </button>
            </div>
