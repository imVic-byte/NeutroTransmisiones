...
<template>
  <div class="neutro-background min-h-screen">
    <navbar class="navbar" titulo="NeutroTransmisiones" subtitulo="Vehículos" />
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 pt-4">
      ...
      <div class="mb-6 hidden sm:block">
        <h1 class="text-2xl font-bold neutro-font">Listado de Vehículos</h1>
        <p class="text-sm neutro-font mt-1">{{ vehiculos.length }} vehículos registrados</p>
      </div>
      ...
      <div class="md:hidden space-y-3">
        ...
        >
          ...
          <button class="neutro-primary mt-2 w-full neutro-font px-2 py-1 rounded-xl hover:opacity-90 transition">
            Ver Vehículo
          </button>
        </div>
