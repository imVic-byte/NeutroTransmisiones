...
<template>
    ...
    <div class="max-w-4xl mx-auto p-4 pb-20">
        ...
        <div v-else-if="historial.length === 0" class="flex flex-col items-center justify-center py-16 px-4 text-center border-2 border-dashed border-gray-100 rounded-xl neutro-secondary">
            <div class="neutro-secondary p-4 rounded-full mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 neutro-font" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                </svg>
            </div>
            <h3 class="text-lg font-bold neutro-font mb-1">No hay historial disponible</h3>
            <p class="neutro-font max-w-sm">Aún no tienes órdenes de trabajo registradas en tu historial. Cuando realices trabajos, aparecerán aquí.</p>
        </div>
