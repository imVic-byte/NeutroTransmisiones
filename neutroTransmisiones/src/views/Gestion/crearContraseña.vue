...
const updatePassword = async () => {
  ...
  try {
    ...
    alert('Contraseña establecida. Bienvenido a NeutroTransmisiones.')
    ...
    <div class="content-container">
      <div class="password-card">
        <div class="header-section">
          ...
          <p>Establece una clave segura para acceder al sistema NeutroTransmisiones.</p>
        </div>
...
.password-card {
  background-color: var(--neutro-font);
  width: 100%;
  max-width: 480px;
  padding: 2.5rem;
  border-radius: 16px;
