...
<template>
    ...
    <div v-else>
    <navbar titulo="NeutroTransmisiones" subtitulo="Confirmar OT" class="navbar" searchInput="false" />
    <div class="pb-28 mx-auto p-4 max-w-lg">
        <div class="flex flex-col gap-2">
            <label for="fecha-ingreso" class="text-lg font-bold neutro-font">Fecha de Ingreso</label>
            <input type="date" id="fecha-ingreso" v-model="fechaIngreso" 
            class="rounded-xl mx-4 px-4 py-2 neutro-primary neutro-font font-bold" />
            <label for="trabajador" class="text-lg font-bold neutro-font">Trabajador</label>
            ...
            <button class="neutro-font neutro-font font-bold px-4 py-2 rounded-full" @click="confirmarOT">Confirmar OT</button>
        </div>
    </div>
    </div>
