    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="flex justify-between items-center mb-6">
        <div class="md:block hidden">
            <h2 class="text-xl font-bold neutro-font">Listado de Órdenes</h2>
            <p class="text-sm neutro-font">Gestiona los trabajos activos en el taller</p>
        </div>
        <div class="flex justify-end w-full items-center gap-2">

          <button @click="handleTodas()" class="neutro-primary cursor-pointer rounded-full text-white font-bold py-2 px-4 shadow-sm border border-gray-100 hover:opacity-80 transition-all flex items-center gap-2">
