        ...
        <div class="card-shadow overflow-hidden border border-gray-100 servi-adapt-bg">
          ...
          <div class="p-4">
            ...
            <div v-for="item in FichasEnDeuda" :key="item.id"
              class="flex items-center justify-between neutro-primary py-3 border-b last:border-0 hover:opacity-80 px-2 rounded-xl transition-colors">
              <div class="min-w-0">
        ...
        <div class="card-shadow overflow-hidden border border-gray-100 servi-adapt-bg">
          ...
          <div class="p-4">
            ...
            <div v-for="abono in abonos" :key="abono.id"
              class="flex justify-between py-3 neutro-primary border-b last:border-0 hover:opacity-80 px-2 rounded-xl transition-colors">
              <div class="min-w-0">
