...
<template>
  <div class="neutro-background min-h-screen font-sans">
    <navbar titulo="NeutroTransmisiones" subtitulo="Nueva Ficha de Trabajo" class="navbar sticky top-0 z-50 shadow-sm" />
        ...
        <div class="lg:col-span-5 relative">
          <div class="servi-adapt-bg shadow-xl sticky top-24 rounded-xl">
            ...
            <button @click="guardarNuevaFicha"
              class="w-full neutro-primary neutro-font text-sm font-bold py-4 px-4 rounded-b-lg hover:bg-blue-800 transition-all flex justify-center items-center gap-3 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              :disabled="loading">
