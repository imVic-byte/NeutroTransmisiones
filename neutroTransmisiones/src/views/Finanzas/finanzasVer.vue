...
<template>
  <div class="min-h-screen neutro-background font-sans">
    <navbar titulo="NeutroTransmisiones" subtitulo="Detalle de Transacción" class="navbar"></navbar>
    ...
    <div class="max-w-4xl mx-auto space-y-6 pt-5 pb-30 px-4 md:px-8">
      <div class="flex justify-between">
        ...
        <div class="flex gap-2">
          ...
          <button @click="router.push({ name: 'finanzasEditar', params: { id: transaccion.id } })" class="neutro-primary text-white p-2 rounded-xl font-bold text-sm">Editar</button>
        </div>
      </div>
      ...
      <div class="neutro-secondary rounded-lg shadow-xl pb-20">
        ...
        <div v-if="transaccion.transacciones_detalle && transaccion.transacciones_detalle.length > 0" class=" px-6">
      ...
      <div class="shadow-xl pb-2 rounded-lg neutro-secondary">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8 px-6">
          ...
          <div v-if="transaccion.cantidad">
            <p class="text-xs text-white font-bold uppercase tracking-wider mb-1">Cantidad</p>
            <p class="text-lg font-bold text-white">{{ transaccion.cantidad }}</p>
          </div>
