...
<template>
  <div class="min-h-screen neutro-background font-sans">
    <navbar titulo="NeutroTransmisiones" subtitulo="Control de Transacciones" class="navbar"></navbar>
      ...
      <template v-else>
        ...
        <div class="grid grid-cols-1 gap-3 md:hidden mt-4">
          ...
          <div v-for="t in transaccionesPaginadas" :key="t.id" class="neutro-primary p-4 rounded-lg shadow-lg">
            ...
            <button @click="handleRedirigir(t.id)" class="w-full neutro-font py-2.5 rounded-md font-semibold text-sm">
              Ver Detalle
            </button>
          </div>
        </div>
        ...
        <div v-if="totalPaginas > 1" class="flex justify-center items-center gap-4 pt-4 pb-2">
          <button 
            ...
            :class="paginaActual === 1 ? 'neutro-font cursor-not-allowed' : 'neutro-primary text-white hover:opacity-90 cursor-pointer'"
          >
            ← Anterior
          </button>
          ...
          <button 
            ...
            class="px-4 py-2 rounded-md font-semibold text-sm transition shadow-sm"
            :class="paginaActual === totalPaginas ? 'neutro-font cursor-not-allowed' : 'neutro-primary text-white hover:opacity-90 cursor-pointer'"
          >
            Siguiente →
          </button>
        </div>
