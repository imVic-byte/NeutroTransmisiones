...
<template>
  <div class="min-h-screen neutro-background font-sans">
    ...
    <div class="max-w-4xl mx-auto space-y-6 pt-5 pb-30 px-4 md:px-8">
      ...
      <div class="neutro-secondary shadow-xl rounded-lg">
        <form @submit.prevent="guardarTransaccion" class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-6">
            <div class="space-y-2">
              ...
              <select v-model="formulario.tipo" required class="w-full px-4 py-2 rounded-md outline-none neutro-secondary border text-white border-gray-100">
            ...
            <div class="space-y-2">
              ...
              <input type="date" v-model="formulario.fecha" required class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none neutro-secondary border text-white border-gray-100">
            </div>
          </div>

          <div class="space-y-2 px-6">
            <label class="block text-sm font-bold text-white">Descripción</label>
            <input type="text" v-model="formulario.descripcion" required class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none neutro-secondary border text-white border-gray-100" placeholder="Ej: Filtro de aceite, Diagnóstico...">
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 px-6">
            <div class="space-y-2">
              ...
              <input type="text" v-model="formulario.proveedor" class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none neutro-secondary border text-white border-gray-100">
            </div>

            <div class="space-y-2">
              <label class="block text-sm font-bold text-white">Documento</label>
              <select v-model="formulario.documento" class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none neutro-secondary border text-white border-gray-100">
            ...
            <div class="space-y-2">
              ...
              <input type="text" v-model="formulario.nro_documento" class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none neutro-secondary border text-white border-gray-100">
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-6">
            <div class="space-y-2">
              ...
              <select v-model="formulario.forma_pago" class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none neutro-secondary border text-white border-gray-100">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-6">
            <div class="space-y-2">
              ...
              <input type="number" v-model="formulario.valor_iva_incluido" @input="calcularValores" required min="0" class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none neutro-secondary border text-white border-gray-100">
            </div>

            <div class="space-y-2">
              <label class="block text-sm font-bold text-white">Cantidad</label>
              <input type="number" v-model="formulario.cantidad" @input="calcularValores" required min="1" class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none neutro-secondary border text-white border-gray-100">
            </div>
          </div>

          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 neutro-secondary p-4 rounded-md border border-gray-100 mx-6">
            <div class="space-y-1">
              <label class="block text-xs font-bold text-white uppercase">Valor Neto Calculado</label>
              <p class="text-lg font-bold text-white">{{ formatearDinero(formulario.valor_neto) }}</p>
            </div>
            <div class="space-y-1">
              <label class="block text-xs font-bold text-white uppercase">IVA Calculado</label>
              <p class="text-lg font-bold text-white">{{ formatearDinero(formulario.iva) }}</p>
            </div>
            <div class="space-y-1">
              <label class="block text-xs font-bold text-white uppercase">Precio Unitario Calculado</label>
              <p class="text-lg font-bold text-white">{{ formatearDinero(formulario.precio_costo_unitario) }}</p>
            </div>
          </div>
          ...
          <div class="space-y-2 px-6">
            ...
            <textarea v-model="formulario.observacion" rows="3" class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none neutro-secondary border text-white border-gray-100"></textarea>
          </div>
          ...
          <div class="flex justify-end py-4 mx-6">
            <button type="submit" :disabled="guardando" class="neutro-primary text-white hover:opacity-90 font-bold py-3 px-8 rounded-md shadow-md transition disabled:opacity-50">
